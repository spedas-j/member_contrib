...
;         plot_dfg:     set this flag to plot DFG data (GSE or GSM coordinate)
;         fac:          set this flag to plot DFG data in the fac coordinate
;         gsm:          set this flag to plot DFG data in the GSM coordinate
;
; EXAMPLE:
;
;     To plot relative positions from the averaged position of all probes and DFG data 
;     MMS>  mms_pos_dfg_all_kitamura,['2015-09-01/12:00:00','2015-09-01/15:00:00'],probe_orig='0',smooth_p=20.d,/plot_dfg
;     MMS>  mms_pos_dfg_all_kitamura,['2015-09-01/12:00:00','2015-09-01/15:00:00'],probe_orig='0',smooth_p=20.d,/plot_dfg,/no_update
;
; NOTES:
...
pro mms_pos_dfg_all_kitamura,trange,probe_orig=probe_orig,smooth_p=smooth_p,no_load=no_load,dfg_ql=dfg_ql,no_update=no_update,delete=delete,plot_dfg=plot_dfg,fac=fac,gsm=gsm
...
;  mstart=time_double(time_string(trange[0],format=0,precision=-3))
  ...
  if undefined(smooth_p) then smooth_p=20.d
  ...
  if undefined(no_load) then begin
    ...
    if strlen(tnames('mms1_dfg_srvy_l2pre_'+coord)) eq 0 then begin
      mms_load_fgm,trange=trange,instrument='dfg',probes=['1','2','3','4'],data_rate='srvy',level='ql',no_update=no_update;,/no_attitude_data
      name_ql='_ql'
      name_level='srvy_'+coord+'_bvec'
      name_level2='srvy_'+coord+'_btot'
    endif else begin
      name_ql=''
      name_level='srvy_l2pre_'+coord+'_bvec'
      name_level2='srvy_l2pre_'+coord+'_btot'
    endelse
  endif else begin
  ...
  dum=indgen(long((trange[1]-trange[0])*10.d),/double)*0.1d + trange[0]
  store_data,'dummy',data={x:dum,y:dum}
  tinterpol_mxn,'mms1'+name_ql+'_pos_'+coord,'dummy',/overwrite
  tinterpol_mxn,'mms2'+name_ql+'_pos_'+coord,'dummy',/overwrite
  tinterpol_mxn,'mms3'+name_ql+'_pos_'+coord,'dummy',/overwrite
  tinterpol_mxn,'mms4'+name_ql+'_pos_'+coord,'dummy',/overwrite
  store_data,'dummy',/delete

  get_data,'mms1'+name_ql+'_pos_'+coord,data=pos1
  get_data,'mms2'+name_ql+'_pos_'+coord,data=pos2
  get_data,'mms3'+name_ql+'_pos_'+coord,data=pos3
  get_data,'mms4'+name_ql+'_pos_'+coord,data=pos4
  ...
  store_data,'mms'+name_ql+'_pos_'+coord,data={x:pos1.x,y:[[origin[*,0]],[origin[*,1]],[origin[*,2]],[origin_r]]}

  store_data,'mms1'+name_ql+'_relpos_'+coord,data={x:pos1.x,y:pos1.y[*,0:2]-origin[*,0:2]}
  store_data,'mms2'+name_ql+'_relpos_'+coord,data={x:pos2.x,y:pos2.y[*,0:2]-origin[*,0:2]}
  store_data,'mms3'+name_ql+'_relpos_'+coord,data={x:pos3.x,y:pos3.y[*,0:2]-origin[*,0:2]}
  store_data,'mms4'+name_ql+'_relpos_'+coord,data={x:pos4.x,y:pos4.y[*,0:2]-origin[*,0:2]}
  store_data,'mms'+name_ql+'_relpos_'+coord+'_x',data={x:pos1.x,y:[[pos1.y[*,0]-origin[*,0]],[pos2.y[*,0]-origin[*,0]],[pos3.y[*,0]-origin[*,0]],[pos4.y[*,0]-origin[*,0]]]}
  store_data,'mms'+name_ql+'_relpos_'+coord+'_y',data={x:pos1.x,y:[[pos1.y[*,1]-origin[*,1]],[pos2.y[*,1]-origin[*,1]],[pos3.y[*,1]-origin[*,1]],[pos4.y[*,1]-origin[*,1]]]}
  store_data,'mms'+name_ql+'_relpos_'+coord+'_z',data={x:pos1.x,y:[[pos1.y[*,2]-origin[*,2]],[pos2.y[*,2]-origin[*,2]],[pos3.y[*,2]-origin[*,2]],[pos4.y[*,2]-origin[*,2]]]}
  store_data,'mms'+name_ql+'_relpos_'+coord+'_r',data={x:pos1.x,y:[[sqrt((pos1.y[*,0]-origin[*,0])^2.d +(pos1.y[*,1]-origin[*,1])^2.d +(pos1.y[*,2]-origin[*,2])^2.d)], $
  ...
  options,'mms1'+name_ql+'_relpos_'+coord,constant=0.0,colors=[2,4,6],ytitle='mms1_ql!CRelative!CPosition!C'+strupcase(coord),ysubtitle='[km]',labels=['x','y','z'],labflag=-1
  options,'mms2'+name_ql+'_relpos_'+coord,constant=0.0,colors=[2,4,6],ytitle='mms2_ql!CRelative!CPosition!C'+strupcase(coord),ysubtitle='[km]',labels=['x','y','z'],labflag=-1
  options,'mms3'+name_ql+'_relpos_'+coord,constant=0.0,colors=[2,4,6],ytitle='mms3_ql!CRelative!CPosition!C'+strupcase(coord),ysubtitle='[km]',labels=['x','y','z'],labflag=-1
  options,'mms4'+name_ql+'_relpos_'+coord,constant=0.0,colors=[2,4,6],ytitle='mms4_ql!CRelative!CPosition!C'+strupcase(coord),ysubtitle='[km]',labels=['x','y','z'],labflag=-1
  options,'mms'+name_ql+'_relpos_'+coord+'_x',constant=0.0,colors=[0,2,4,6],ytitle='Relative!CPosition!C'+strupcase(coord)+' X',ysubtitle='[km]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
  options,'mms'+name_ql+'_relpos_'+coord+'_y',constant=0.0,colors=[0,2,4,6],ytitle='Relative!CPosition!C'+strupcase(coord)+' Y',ysubtitle='[km]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
  options,'mms'+name_ql+'_relpos_'+coord+'_z',constant=0.0,colors=[0,2,4,6],ytitle='Relative!CPosition!C'+strupcase(coord)+' Z',ysubtitle='[km]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
  options,'mms'+name_ql+'_relpos_'+coord+'_r',constant=0.0,colors=[0,2,4,6],ytitle='Distance!Cfrom!COrigin',ysubtitle='[km]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
  ...
  if fix(probe_orig) eq 0 then begin
    ...
    if name_level eq 'srvy_l2pre_'+coord+'_bvec' then begin
      calc,'"mms_dfg_srvy_l2pre_'+coord+'_bvec_avg"=("mms1_dfg_srvy_l2pre_'+coord+'_bvec_avg"+"mms2_dfg_srvy_l2pre_'+coord+'_bvec_avg"+"mms3_dfg_srvy_l2pre_'+coord+'_bvec_avg"+"mms4_dfg_srvy_l2pre_'+coord+'_bvec_avg")/4.d'
    endif else begin
      calc,'"mms_dfg_srvy_'+coord+'_bvec_avg"=("mms1_dfg_srvy_'+coord+'_bvec_avg"+"mms2_dfg_srvy_'+coord+'_bvec_avg"+"mms3_dfg_srvy_'+coord+'_bvec_avg"+"mms4_dfg_srvy_'+coord+'_bvec_avg")/4.d'
    endelse
    tsmooth_in_time,'mms_dfg_'+name_level+'_avg',smooth_p,newname='mms_dfg_srvy_'+coord+'_bvec_smoothed'
  endif else begin
    probe=strcompress(string(probe_orig),/rem)
    tsmooth_in_time,'mms'+probe+'_dfg_'+name_level,smooth_p,newname='mms_dfg_srvy_'+coord+'_bvec_smoothed'
    copy_data,'mms'+probe+'_dfg_'+name_level,'mms_dfg_'+name_level
  endelse

  for p=1,4 do begin
      tinterpol_mxn,'mms'+strcompress(string(p),/rem)+'_dfg_'+name_level,'mms'+strcompress(string(p),/rem)+'_dfg_'+name_level,newname='mms'+strcompress(string(p),/rem)+'_dfg_srvy_'+coord+'_bvec_intpl'
      get_data,'mms'+strcompress(string(p),/rem)+'_dfg_'+name_level,data=B
      tinterpol_mxn,'mms_dfg_srvy_'+coord+'_bvec_smoothed','mms'+strcompress(string(p),/rem)+'_dfg_'+name_level,newname='mms_dfg_srvy_'+coord+'_bvec_smoothed_intpl'
      get_data,'mms_dfg_srvy_'+coord+'_bvec_smoothed_intpl',data=smoothed_B
      ...
      tinterpol_mxn,'mms'+name_ql+'_pos_'+coord,'mms'+strcompress(string(p),/rem)+'_dfg_'+name_level,newname='mms'+name_ql+'_pos_'+coord+'_intpl'
      get_data,'mms'+name_ql+'_pos_'+coord+'_intpl',data=pos
      tinterpol_mxn,'mms'+strcompress(string(p),/rem)+name_ql+'_relpos_'+coord,'mms'+strcompress(string(p),/rem)+'_dfg_'+name_level,newname='mms'+strcompress(string(p),/rem)+name_ql+'_relpos_'+coord+'_intpl'
      get_data,'mms'+strcompress(string(p),/rem)+name_ql+'_relpos_'+coord+'_intpl',data=rpos
  ...
  tkm2re,'mms'+name_ql+'_pos_'+coord
  split_vec,'mms'+name_ql+'_pos_'+coord+'_re'
  options,'mms'+name_ql+'_pos_'+coord+'_re_0',ytitle='MMS'+probe+' '+strupcase(coord)+'X [RE]',format='(f7.3)'
  options,'mms'+name_ql+'_pos_'+coord+'_re_1',ytitle='MMS'+probe+' '+strupcase(coord)+'Y [RE]',format='(f7.3)'
  options,'mms'+name_ql+'_pos_'+coord+'_re_2',ytitle='MMS'+probe+' '+strupcase(coord)+'Z [RE]',format='(f7.3)'
  options,'mms'+name_ql+'_pos_'+coord+'_re_3',ytitle='MMS'+probe+' R [RE]',format='(f7.3)'
  
  tplot_options, var_label=['mms'+name_ql+'_pos_'+coord+'_re_3','mms'+name_ql+'_pos_'+coord+'_re_2','mms'+name_ql+'_pos_'+coord+'_re_1','mms'+name_ql+'_pos_'+coord+'_re_0']
...
;    tplot,['mms?_dfg_'+name_level,'mms?_dfg_srvy_fac_hpfilt','mms?'+name_ql+'_relpos_fac','mms?'+name_ql+'_relpos_'+coord,'mms'+name_ql+'_relpos_'+coord+'_?']
;    tplot,['mms?_dfg_'+name_level,'mms?_dfg_srvy_fac_hpfilt','mms_dfg_srvy_fac_hpfilt_?','mms?'+name_ql+'_relpos_fac','mms?'+name_ql+'_relpos_'+coord,'mms'+name_ql+'_relpos_'+coord+'_?']
;    tplot,['mms?_dfg_srvy_fac_hpfilt','mms_dfg_srvy_fac_hpfilt_?','mms'+name_ql+'_relpos_fac_?']
    tplot,['mms?_dfg_'+name_level,'mms?'+name_ql+'_relpos_'+coord,'mms'+name_ql+'_relpos_'+coord+'_?']
  endif else begin
    if undefined(fac) then begin
      ...
      options,'mms_dfg_'+name_level+'_x',constant=0.0,colors=[0,2,4,6],ytitle='MMS!CDFG!C'+strupcase(coord)+' X',ysubtitle='[nT]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
      options,'mms_dfg_'+name_level+'_y',constant=0.0,colors=[0,2,4,6],ytitle='MMS!CDFG!C'+strupcase(coord)+' Y',ysubtitle='[nT]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
      options,'mms_dfg_'+name_level+'_z',constant=0.0,colors=[0,2,4,6],ytitle='MMS!CDFG!C'+strupcase(coord)+' Z',ysubtitle='[nT]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
      options,'mms_dfg_'+name_level2,colors=[0,2,4,6],ytitle='MMS!CDFG!CBtotal',ysubtitle='[nT]',labels=['mms1','mms2','mms3','mms4'],labflag=-1
      tplot,['mms_dfg_'+name_level2,'mms_dfg_'+name_level+'_?','mms'+name_ql+'_relpos_'+coord+'_?']
    endif else begin
