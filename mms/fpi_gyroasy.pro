PRO fpi_gyroasy,tname,range=range,tavg=tavg,full_out=full_out,datagap=datagap
  ...
  options,tname+'_ratio',spec=1,datagap=datagap,color_table=0,yticks=4,zticks=1,yrange=[0.d,360.d],zrange=[1.d/range,range],zlog=1
  ...
  if not undefined(tavg) then begin
    ...
    if not undefined(full_out) then begin
      ...
      options,tname+'_avg',spec=1,datagap=datagap,yticks=4,zticks=1,yrange=[0.d,360.d]
    endif
    ...
    options,tname+'_ratio_avg',spec=1,datagap=datagap,color_table=0,yticks=4,zticks=1,yrange=[0.d,360.d],zrange=[1.d/range,range],zlog=1
  endif
