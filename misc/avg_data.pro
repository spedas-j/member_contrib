...
;
; This version was made by T. Hori by slightly modifying the original 
; avg_data.pro in ssl_general/tplot/. 
; This one runs much faster than the original one does since it uses
; time_average.pro to perform the averaging calculation. 
;
;-
...
if not keyword_set(res) then res = 60d   ; 1 minute resolution as default
res = double(res)
